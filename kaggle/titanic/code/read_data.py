...
#
# exit()
rf=GradientBoostingClassifier(max_features=5,learning_rate=0.1,n_estimators=40,max_depth=6,min_samples_leaf=13,min_samples_split=38,subsample=0.75) #learning_rate=0.05,n_estimators=100,subsample=0.75,max_depth=4,min_samples_split=15
